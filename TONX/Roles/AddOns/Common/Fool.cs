...
public static class Fool
{
    ...
    public static void SetupCustomOption()
    {
        ...
        OptionImpFoolCanNotSabotage = BooleanOptionItem
            .Create(Id + 20, "ImpFoolCanNotSabotage", true, TabGroup.Addons, false)
            .SetParent(CustomRoleSpawnChances[CustomRoles.Fool]);
        OptionImpFoolCanNotOpenDoor = BooleanOptionItem
            .Create(Id + 21, "FoolCanNotOpenDoor", false, TabGroup.Addons, false)
            .SetParent(CustomRoleSpawnChances[CustomRoles.Fool]);
    }
