...
public sealed class Demon : RoleBase, IKiller, ISchrodingerCatOwner
{
    ...
    private static void SetupOptionItem()
    {
        OptionKillCooldown = FloatOptionItem
            .Create(RoleInfo, 10, OptionName.DemonKillCooldown, new(1f, 180f, 1f), 2f, false)
        ...
        OptionDamage = IntegerOptionItem.Create(RoleInfo, 14, OptionName.DemonDamage, new(1, 100, 1), 15, false)
            .SetValueFormat(OptionFormat.Health);
        OptionSelfHealthMax = IntegerOptionItem
            .Create(RoleInfo, 15, OptionName.DemonSelfHealthMax, new(100, 100, 5), 100, false)
            .SetValueFormat(OptionFormat.Health);
    ...
    public bool OnCheckMurderAsKiller(MurderInfo info)
    {
        ...
        Logger.Info($"{killer.GetNameWithRole()} 对玩家 {target.GetNameWithRole()} 造成了 {OptionDamage.GetInt()} 点伤害",
            "Demon");
        return false;
    }
    ...
    public override bool OnCheckMurderAsTarget(MurderInfo info)
    {
        ...
        Logger.Info($"{killer.GetNameWithRole()} 对玩家 {target.GetNameWithRole()} 造成了 {OptionSelfDamage.GetInt()} 点伤害",
            "Demon");
        return false;
    }
