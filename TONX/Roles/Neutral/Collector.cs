...
public sealed class Collector : RoleBase
{
    ...
    {
        CollectorCollectAmount = IntegerOptionItem
            .Create(RoleInfo, 10, OptionName.CollectorCollectAmount, new(1, 999, 1), 20, false)
    ...
    public override string GetProgressText(bool comms = false)
    {
        ...
        return Utils.ColorString(Utils.GetRoleColor(CustomRoles.Collector).ShadeColor(0.25f),
            $"({VoteAmount}/{CollectNum})");
    }
