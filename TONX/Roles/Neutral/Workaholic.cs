...
public sealed class Workaholic : RoleBase
{
    ...
    {
        OptionVentCooldown = FloatOptionItem
            .Create(RoleInfo, 10, GeneralOption.VentCooldown, new(2.5f, 180f, 2.5f), 10f, false)
            .SetValueFormat(OptionFormat.Seconds);
        OptionNoWinAtDeath =
            BooleanOptionItem.Create(RoleInfo, 11, OptionName.WorkaholicCannotWinAtDeath, false, false);
        OptionVisibleToEveryone =
            BooleanOptionItem.Create(RoleInfo, 12, OptionName.WorkaholicVisibleToEveryone, true, false);
        // 20-23を使用
