...
public sealed class TimeThief : RoleBase, IMeetingTimeAlterable, IImpostor
{
    ...
    private static void SetupOptionItem()
    {
        OptionKillCooldown = FloatOptionItem
            .Create(RoleInfo, 10, GeneralOption.KillCooldown, new(2.5f, 180f, 2.5f), 30f, false)
            .SetValueFormat(OptionFormat.Seconds);
        OptionDecreaseMeetingTime = IntegerOptionItem.Create(RoleInfo, 11, OptionName.TimeThiefDecreaseMeetingTime,
                new(0, 100, 1), 25, false)
            .SetValueFormat(OptionFormat.Seconds);
        OptionLowerLimitVotingTime = IntegerOptionItem.Create(RoleInfo, 12, OptionName.TimeThiefLowerLimitVotingTime,
                new(1, 300, 1), 10, false)
            .SetValueFormat(OptionFormat.Seconds);
        OptionReturnStolenTimeUponDeath =
            BooleanOptionItem.Create(RoleInfo, 13, OptionName.TimeThiefReturnStolenTimeUponDeath, true, false);
    }
