...
public sealed class Zombie : RoleBase, IImpostor
{
    ...
    private static void SetupOptionItem()
    {
        OptionKillCooldown = FloatOptionItem
            .Create(RoleInfo, 10, GeneralOption.KillCooldown, new(2.5f, 180f, 2.5f), 12f, false)
            .SetValueFormat(OptionFormat.Seconds);
        OptionSpeedReduce = FloatOptionItem
            .Create(RoleInfo, 11, OptionName.ZombieSpeedReduce, new(0.01f, 1f, 0.01f), 0.03f, false)
