...
public class StringOptionItem : OptionItem
{
    ...
    // コンストラクタ
    public StringOptionItem(int id, string name, int defaultValue, TabGroup tab, bool isSingleValue,
        string[] selections)
    ...
    public static StringOptionItem Create(
        SimpleRoleInfo roleInfo, int idOffset, Enum name, string[] selections, int defaultIndex, bool isSingleValue,
