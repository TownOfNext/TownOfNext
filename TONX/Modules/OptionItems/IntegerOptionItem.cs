...
public class IntegerOptionItem : OptionItem
{
    ...
    // コンストラクタ
    public IntegerOptionItem(int id, string name, int defaultValue, TabGroup tab, bool isSingleValue,
    ...
    public static IntegerOptionItem Create(
        SimpleRoleInfo roleInfo, int idOffset, Enum name, IntegerValueRule rule, int defaultValue, bool isSingleValue,
