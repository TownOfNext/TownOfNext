...
public static class Options
{
    ...
    public static void Load()
    {
        ...
        // 预设//9人以上部屋で落ちる現象の対策
        FixSpawnPacketSize = BooleanOptionItem
            .Create(1_000_200, "FixSpawnPacketSize", false, TabGroup.SystemSettings, true)
        ...
        var sortedRoleInfo = CustomRoleManager.AllRolesInfo.Values
            .Where(role => !(role.RoleName.GetRoleInfo()?.Hidden ?? false)).OrderBy(role => role.ConfigId);

        // 各职业的总体设定
        ImpKnowAlliesRole = BooleanOptionItem
            .Create(1_000_001, "ImpKnowAlliesRole", true, TabGroup.ImpostorRoles, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetHeader(true);
        ImpKnowWhosMadmate = BooleanOptionItem
            .Create(1_000_002, "ImpKnowWhosMadmate", false, TabGroup.ImpostorRoles, false)
            .SetGameMode(CustomGameMode.Standard);
        ImpCanKillMadmate = BooleanOptionItem
            .Create(1_000_003, "ImpCanKillMadmate", true, TabGroup.ImpostorRoles, false)
            .SetGameMode(CustomGameMode.Standard);

        MadmateKnowWhosMadmate = BooleanOptionItem
            .Create(1_001_001, "MadmateKnowWhosMadmate", false, TabGroup.ImpostorRoles, false)
            .SetHeader(true)
            .SetGameMode(CustomGameMode.Standard);
        MadmateKnowWhosImp = BooleanOptionItem
            .Create(1_001_002, "MadmateKnowWhosImp", true, TabGroup.ImpostorRoles, false)
            .SetGameMode(CustomGameMode.Standard);
        MadmateCanKillImp = BooleanOptionItem
            .Create(1_001_003, "MadmateCanKillImp", true, TabGroup.ImpostorRoles, false)
            .SetGameMode(CustomGameMode.Standard);

        DoubleTriggerThreshold = FloatOptionItem.Create(1_002_001, "DoubleTriggerThreshold", new(0.3f, 1f, 0.1f), 0.5f,
                TabGroup.ImpostorRoles, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetHeader(true)
            .SetValueFormat(OptionFormat.Seconds);
        DefaultShapeshiftCooldown = FloatOptionItem.Create(1_002_002, "DefaultShapeshiftCooldown", new(5f, 999f, 5f),
                15f, TabGroup.ImpostorRoles, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetValueFormat(OptionFormat.Seconds);
        DeadImpCantSabotage = BooleanOptionItem
            .Create(1_002_003, "DeadImpCantSabotage", false, TabGroup.ImpostorRoles, false)
            .SetGameMode(CustomGameMode.Standard);

        NeutralRolesMinPlayer = IntegerOptionItem.Create(1_003_001, "NeutralRolesMinPlayer", new(0, 15, 1), 0,
                TabGroup.NeutralRoles, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetHeader(true)
            .SetValueFormat(OptionFormat.Players);
        NeutralRolesMaxPlayer = IntegerOptionItem.Create(1_003_002, "NeutralRolesMaxPlayer", new(0, 15, 1), 0,
                TabGroup.NeutralRoles, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetValueFormat(OptionFormat.Players);
        NeutralRoleWinTogether = BooleanOptionItem
            .Create(1_003_003, "NeutralRoleWinTogether", false, TabGroup.NeutralRoles, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetHeader(true);
        NeutralWinTogether = BooleanOptionItem
            .Create(1_003_004, "NeutralWinTogether", false, TabGroup.NeutralRoles, false)
        ...
        // Impostor
        sortedRoleInfo
            .Where(role => role.CustomRoleType == CustomRoleTypes.Impostor && role.Experimental == setupExpNow)
            .Do(info =>
            {
        ...
        // Crewmate
        sortedRoleInfo
            .Where(role => role.CustomRoleType == CustomRoleTypes.Crewmate && role.Experimental == setupExpNow)
            .Do(info =>
            {
                SetupRoleOptions(info);
                info.OptionCreator?.Invoke();
        ...
        // Neutral
        sortedRoleInfo.Where(role => role.CustomRoleType == CustomRoleTypes.Neutral && role.Experimental == setupExpNow)
            .Do(info =>
            {
                SetupRoleOptions(info);
                info.OptionCreator?.Invoke();
        ...
        LoverKnowRoles = BooleanOptionItem.Create(80100 + 4, "LoverKnowRoles", true, TabGroup.Addons, false)
            .SetParent(Options.CustomRoleSpawnChances[CustomRoles.Lovers])
            .SetGameMode(CustomGameMode.Standard);
        LoverSuicide = BooleanOptionItem.Create(80100 + 3, "LoverSuicide", true, TabGroup.Addons, false)
            .SetParent(Options.CustomRoleSpawnChances[CustomRoles.Lovers])
            .SetGameMode(CustomGameMode.Standard);
        ...
        KickLowLevelPlayer = IntegerOptionItem.Create(2_000_001, "KickLowLevelPlayer", new(0, 100, 1), 0,
                TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetValueFormat(OptionFormat.Level)
            .SetHeader(true)
            .SetColor(new Color32(0, 121, 255, byte.MaxValue));
        KickAndroidPlayer = BooleanOptionItem
            .Create(2_000_002, "KickAndroidPlayer", false, TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(0, 121, 255, byte.MaxValue));
        KickPlayerFriendCodeNotExist = BooleanOptionItem.Create(2_000_003, "KickPlayerFriendCodeNotExist", false,
                TabGroup.SystemSettings, true)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(0, 121, 255, byte.MaxValue));
        ApplyDenyNameList = BooleanOptionItem
            .Create(2_000_004, "ApplyDenyNameList", true, TabGroup.SystemSettings, true)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(0, 121, 255, byte.MaxValue));
        ...
        AutoKickStart = BooleanOptionItem.Create(2_000_006, "AutoKickStart", false, TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(0, 121, 255, byte.MaxValue));
        AutoKickStartTimes = IntegerOptionItem
            .Create(2_000_007, "AutoKickStartTimes", new(0, 99, 1), 1, TabGroup.SystemSettings, false)
            .SetParent(AutoKickStart)
            .SetGameMode(CustomGameMode.All)
            .SetValueFormat(OptionFormat.Times)
            .SetColor(new Color32(0, 121, 255, byte.MaxValue));
        AutoKickStartAsBan = BooleanOptionItem
            .Create(2_000_008, "AutoKickStartAsBan", false, TabGroup.SystemSettings, false).SetParent(AutoKickStart)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(0, 121, 255, byte.MaxValue));
        AutoKickStopWords = BooleanOptionItem
            .Create(2_000_009, "AutoKickStopWords", false, TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(0, 121, 255, byte.MaxValue));
        AutoKickStopWordsTimes = IntegerOptionItem
            .Create(2_000_010, "AutoKickStopWordsTimes", new(0, 99, 1), 3, TabGroup.SystemSettings, false)
            .SetParent(AutoKickStopWords)
            .SetGameMode(CustomGameMode.All)
            .SetValueFormat(OptionFormat.Times)
            .SetColor(new Color32(0, 121, 255, byte.MaxValue));
        AutoKickStopWordsAsBan = BooleanOptionItem
            .Create(2_000_011, "AutoKickStopWordsAsBan", false, TabGroup.SystemSettings, false)
            .SetParent(AutoKickStopWords)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(0, 121, 255, byte.MaxValue));
        AutoWarnStopWords = BooleanOptionItem
            .Create(2_000_012, "AutoWarnStopWords", false, TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(0, 121, 255, byte.MaxValue));
        ...
        AutoDisplayKillLog = BooleanOptionItem
            .Create(2_002_001, "AutoDisplayKillLog", true, TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetHeader(true)
            .SetColor(new Color32(246, 250, 112, byte.MaxValue));
        AutoDisplayLastResult = BooleanOptionItem
            .Create(2_002_002, "AutoDisplayLastResult", true, TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(246, 250, 112, byte.MaxValue));
        ChangeNameToRoleInfo = BooleanOptionItem
            .Create(2_002_003, "ChangeNameToRoleInfo", false, TabGroup.SystemSettings, false)
            .SetColor(new Color32(246, 250, 112, byte.MaxValue));
        SendRoleDescriptionFirstMeeting = BooleanOptionItem.Create(2_002_004, "SendRoleDescriptionFirstMeeting", false,
                TabGroup.SystemSettings, false)
            .SetColor(new Color32(246, 250, 112, byte.MaxValue));
        HideGameSettings = BooleanOptionItem
            .Create(2_002_005, "HideGameSettings", false, TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(246, 250, 112, byte.MaxValue));
        ...
        SuffixMode = StringOptionItem.Create(2_003_001, "SuffixMode", suffixModes, 0, TabGroup.SystemSettings, true)
            ...
            .SetHeader(true)
            .SetColor(new Color32(255, 0, 96, byte.MaxValue));
        FormatNameMode = StringOptionItem
            .Create(2_003_002, "FormatNameMode", formatNameModes, 0, TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(255, 0, 96, byte.MaxValue));
        DisableEmojiName = BooleanOptionItem.Create(2_003_003, "DisableEmojiName", true, TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(255, 0, 96, byte.MaxValue));
        PlayerCanSetColor = BooleanOptionItem
            .Create(2_003_004, "PlayerCanSetColor", false, TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(255, 0, 96, byte.MaxValue));
        KPDCamouflageMode = BooleanOptionItem
            .Create(2_003_005, "KPDCamouflageMode", false, TabGroup.SystemSettings, false)
            .SetColor(new Color32(255, 0, 96, byte.MaxValue));
        AllowPlayerPlayWithColoredNameByCustomTags = BooleanOptionItem.Create(2_003_006,
                "AllowPlayerPlayWithColoredNameByCustomTags", false, TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(255, 0, 96, byte.MaxValue));
        NonModPleyerCanShowUpperCustomTag = BooleanOptionItem.Create(2_003_007, "NonModPleyerCanShowUpperCustomTag",
                false, TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(255, 0, 96, byte.MaxValue));
        ...
        AllowConsole = BooleanOptionItem.Create(2_004_002, "AllowConsole", false, TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(147, 118, 224, byte.MaxValue));
        EnableDirectorMode = BooleanOptionItem
            .Create(2_004_003, "EnableDirectorMode", false, TabGroup.SystemSettings, false)
            .SetColor(new Color32(147, 118, 224, byte.MaxValue));
        ...
        EndWhenPlayerBug = BooleanOptionItem.Create(2_004_005, "EndWhenPlayerBug", true, TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(147, 118, 224, byte.MaxValue));
        CheatResponses = StringOptionItem.Create(2_004_006, "CheatResponses", CheatResponsesNames, 0,
                TabGroup.SystemSettings, false)
            .SetGameMode(CustomGameMode.All)
            .SetColor(new Color32(147, 118, 224, byte.MaxValue));
        RoleAssigningAlgorithm = StringOptionItem.Create(2_004_007, "RoleAssigningAlgorithm", roleAssigningAlgorithms,
                4, TabGroup.SystemSettings, true)
            .SetGameMode(CustomGameMode.All)
            .RegisterUpdateValueEvent((object obj, OptionItem.UpdateValueEventArgs args) =>
                IRandom.SetInstanceById(args.CurrentValue))
            .SetColor(new Color32(147, 118, 224, byte.MaxValue));
        ...
        CEMode = StringOptionItem.Create(3_000_001, "ConfirmEjectionsMode", ConfirmEjectionsModes, 2,
                TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetHeader(true)
            .SetColor(new Color32(255, 238, 232, byte.MaxValue));
        ShowImpRemainOnEject = BooleanOptionItem
            .Create(3_000_002, "ShowImpRemainOnEject", true, TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(new Color32(255, 238, 232, byte.MaxValue));
        ShowNKRemainOnEject = BooleanOptionItem
            .Create(3_000_003, "ShowNKRemainOnEject", true, TabGroup.GameSettings, false)
            .SetParent(ShowImpRemainOnEject)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(new Color32(255, 238, 232, byte.MaxValue));
        ShowTeamNextToRoleNameOnEject = BooleanOptionItem.Create(3_000_004, "ShowTeamNextToRoleNameOnEject", false,
                TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(new Color32(255, 238, 232, byte.MaxValue));
        ...
        DisableVanillaRoles = BooleanOptionItem
            .Create(3_001_001, "DisableVanillaRoles", true, TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetHeader(true)
            .SetColor(new Color32(255, 153, 153, byte.MaxValue));
        DisableHiddenRoles = BooleanOptionItem
            .Create(3_001_002, "DisableHiddenRoles", true, TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(new Color32(255, 153, 153, byte.MaxValue));
        ...
        DisableTasks = BooleanOptionItem.Create(3_002_001, "DisableTasks", false, TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(new Color32(255, 153, 153, byte.MaxValue));
        DisableSwipeCard = BooleanOptionItem
            .Create(3_002_002, "DisableSwipeCardTask", false, TabGroup.GameSettings, false).SetParent(DisableTasks)
            .SetGameMode(CustomGameMode.Standard);
        DisableSubmitScan = BooleanOptionItem
            .Create(3_002_003, "DisableSubmitScanTask", false, TabGroup.GameSettings, false).SetParent(DisableTasks)
            .SetGameMode(CustomGameMode.Standard);
        DisableUnlockSafe = BooleanOptionItem
            .Create(3_002_004, "DisableUnlockSafeTask", false, TabGroup.GameSettings, false).SetParent(DisableTasks)
            .SetGameMode(CustomGameMode.Standard);
        DisableUploadData = BooleanOptionItem
            .Create(3_002_005, "DisableUploadDataTask", false, TabGroup.GameSettings, false).SetParent(DisableTasks)
            .SetGameMode(CustomGameMode.Standard);
        DisableStartReactor = BooleanOptionItem
            .Create(3_002_006, "DisableStartReactorTask", false, TabGroup.GameSettings, false).SetParent(DisableTasks)
            .SetGameMode(CustomGameMode.Standard);
        DisableResetBreaker = BooleanOptionItem
            .Create(3_002_007, "DisableResetBreakerTask", false, TabGroup.GameSettings, false).SetParent(DisableTasks)
            .SetGameMode(CustomGameMode.Standard);
        ...
        DisableDevices = BooleanOptionItem.Create(3_004_001, "DisableDevices", false, TabGroup.GameSettings, false)
            .SetColor(new Color32(255, 153, 153, byte.MaxValue))
            .SetGameMode(CustomGameMode.Standard);
        DisableSkeldDevices = BooleanOptionItem
            .Create(3_004_002, "DisableSkeldDevices", false, TabGroup.GameSettings, false).SetParent(DisableDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisableSkeldAdmin = BooleanOptionItem
            .Create(3_004_003, "DisableSkeldAdmin", false, TabGroup.GameSettings, false).SetParent(DisableSkeldDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisableSkeldCamera = BooleanOptionItem
            .Create(3_004_004, "DisableSkeldCamera", false, TabGroup.GameSettings, false).SetParent(DisableSkeldDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisableMiraHQDevices = BooleanOptionItem
            .Create(3_004_005, "DisableMiraHQDevices", false, TabGroup.GameSettings, false).SetParent(DisableDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisableMiraHQAdmin = BooleanOptionItem
            .Create(3_004_006, "DisableMiraHQAdmin", false, TabGroup.GameSettings, false)
            .SetParent(DisableMiraHQDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisableMiraHQDoorLog = BooleanOptionItem
            .Create(3_004_007, "DisableMiraHQDoorLog", false, TabGroup.GameSettings, false)
            .SetParent(DisableMiraHQDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisablePolusDevices = BooleanOptionItem
            .Create(3_004_008, "DisablePolusDevices", false, TabGroup.GameSettings, false).SetParent(DisableDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisablePolusAdmin = BooleanOptionItem
            .Create(3_004_009, "DisablePolusAdmin", false, TabGroup.GameSettings, false).SetParent(DisablePolusDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisablePolusCamera = BooleanOptionItem
            .Create(3_004_010, "DisablePolusCamera", false, TabGroup.GameSettings, false).SetParent(DisablePolusDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisablePolusVital = BooleanOptionItem
            .Create(3_004_011, "DisablePolusVital", false, TabGroup.GameSettings, false).SetParent(DisablePolusDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisableAirshipDevices = BooleanOptionItem
            .Create(3_004_012, "DisableAirshipDevices", false, TabGroup.GameSettings, false).SetParent(DisableDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisableAirshipCockpitAdmin = BooleanOptionItem
            .Create(3_004_013, "DisableAirshipCockpitAdmin", false, TabGroup.GameSettings, false)
            .SetParent(DisableAirshipDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisableAirshipRecordsAdmin = BooleanOptionItem
            .Create(3_004_014, "DisableAirshipRecordsAdmin", false, TabGroup.GameSettings, false)
            .SetParent(DisableAirshipDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisableAirshipCamera = BooleanOptionItem
            .Create(3_004_015, "DisableAirshipCamera", false, TabGroup.GameSettings, false)
            .SetParent(DisableAirshipDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisableAirshipVital = BooleanOptionItem
            .Create(3_004_016, "DisableAirshipVital", false, TabGroup.GameSettings, false)
            .SetParent(DisableAirshipDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisableFungleDevices = BooleanOptionItem
            .Create(3_004_017, "DisableFungleDevices", false, TabGroup.GameSettings, false).SetParent(DisableDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisableFungleVital = BooleanOptionItem
            .Create(3_004_018, "DisableFungleVital", false, TabGroup.GameSettings, false)
            .SetParent(DisableFungleDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisableDevicesIgnoreConditions = BooleanOptionItem
            .Create(3_005_001, "IgnoreConditions", false, TabGroup.GameSettings, false).SetParent(DisableDevices)
            .SetGameMode(CustomGameMode.Standard);
        DisableDevicesIgnoreImpostors = BooleanOptionItem
            .Create(3_005_002, "IgnoreImpostors", false, TabGroup.GameSettings, false)
            .SetParent(DisableDevicesIgnoreConditions)
            .SetGameMode(CustomGameMode.Standard);
        DisableDevicesIgnoreNeutrals = BooleanOptionItem
            .Create(3_005_003, "IgnoreNeutrals", false, TabGroup.GameSettings, false)
            .SetParent(DisableDevicesIgnoreConditions)
            .SetGameMode(CustomGameMode.Standard);
        DisableDevicesIgnoreCrewmates = BooleanOptionItem
            .Create(3_005_004, "IgnoreCrewmates", false, TabGroup.GameSettings, false)
            .SetParent(DisableDevicesIgnoreConditions)
            .SetGameMode(CustomGameMode.Standard);
        DisableDevicesIgnoreAfterAnyoneDied = BooleanOptionItem
            .Create(3_005_005, "IgnoreAfterAnyoneDied", false, TabGroup.GameSettings, false)
            .SetParent(DisableDevicesIgnoreConditions)
            .SetGameMode(CustomGameMode.Standard);
        ...
        SyncButtonMode = BooleanOptionItem.Create(3_010_001, "SyncButtonMode", false, TabGroup.GameSettings, false)
            ...
            .SetColor(new Color32(147, 241, 240, byte.MaxValue))
            .SetGameMode(CustomGameMode.Standard);
        SyncedButtonCount = IntegerOptionItem
            .Create(3_010_002, "SyncedButtonCount", new(0, 100, 1), 10, TabGroup.GameSettings, false)
        ...
        AllAliveMeeting = BooleanOptionItem.Create(3_011_001, "AllAliveMeeting", false, TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(new Color32(147, 241, 240, byte.MaxValue));
        AllAliveMeetingTime = FloatOptionItem
            .Create(3_011_002, "AllAliveMeetingTime", new(1f, 300f, 1f), 10f, TabGroup.GameSettings, false)
            .SetParent(AllAliveMeeting)
            .SetValueFormat(OptionFormat.Seconds);

        // 附加紧急会议
        AdditionalEmergencyCooldown = BooleanOptionItem.Create(3_012_001, "AdditionalEmergencyCooldown", false,
                TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(new Color32(147, 241, 240, byte.MaxValue));
        AdditionalEmergencyCooldownThreshold = IntegerOptionItem
            .Create(3_012_002, "AdditionalEmergencyCooldownThreshold", new(1, 15, 1), 1, TabGroup.GameSettings, false)
            .SetParent(AdditionalEmergencyCooldown)
            .SetGameMode(CustomGameMode.Standard)
            .SetValueFormat(OptionFormat.Players);
        AdditionalEmergencyCooldownTime = FloatOptionItem
            .Create(3_012_003, "AdditionalEmergencyCooldownTime", new(1f, 60f, 1f), 1f, TabGroup.GameSettings, false)
            .SetParent(AdditionalEmergencyCooldown)
            .SetGameMode(CustomGameMode.Standard)
            .SetValueFormat(OptionFormat.Seconds);
        ...
        VoteMode = BooleanOptionItem.Create(3_013_001, "VoteMode", false, TabGroup.GameSettings, false)
            .SetColor(new Color32(147, 241, 240, byte.MaxValue))
            .SetGameMode(CustomGameMode.Standard);
        WhenSkipVote = StringOptionItem
            .Create(3_013_002, "WhenSkipVote", voteModes[0..3], 0, TabGroup.GameSettings, false).SetParent(VoteMode)
            .SetGameMode(CustomGameMode.Standard);
        WhenSkipVoteIgnoreFirstMeeting = BooleanOptionItem
            .Create(3_013_003, "WhenSkipVoteIgnoreFirstMeeting", false, TabGroup.GameSettings, false)
            .SetParent(WhenSkipVote)
            .SetGameMode(CustomGameMode.Standard);
        WhenSkipVoteIgnoreNoDeadBody = BooleanOptionItem
            .Create(3_013_004, "WhenSkipVoteIgnoreNoDeadBody", false, TabGroup.GameSettings, false)
            .SetParent(WhenSkipVote)
            .SetGameMode(CustomGameMode.Standard);
        WhenSkipVoteIgnoreEmergency = BooleanOptionItem
            .Create(3_013_005, "WhenSkipVoteIgnoreEmergency", false, TabGroup.GameSettings, false)
            .SetParent(WhenSkipVote)
            .SetGameMode(CustomGameMode.Standard);
        WhenNonVote = StringOptionItem.Create(3_013_006, "WhenNonVote", voteModes, 0, TabGroup.GameSettings, false)
            .SetParent(VoteMode)
            .SetGameMode(CustomGameMode.Standard);
        WhenTie = StringOptionItem.Create(3_013_007, "WhenTie", tieModes, 0, TabGroup.GameSettings, false)
            .SetParent(VoteMode)
            .SetGameMode(CustomGameMode.Standard);
        ...
        CommsCamouflage = BooleanOptionItem.Create(3_020_001, "CommsCamouflage", false, TabGroup.GameSettings, false)
            ...
            .SetHeader(true)
            .SetColor(new Color32(241, 212, 227, byte.MaxValue));
        DisableReportWhenCC = BooleanOptionItem
            .Create(3_020_002, "DisableReportWhenCC", false, TabGroup.GameSettings, false).SetParent(CommsCamouflage)
            .SetGameMode(CustomGameMode.Standard);

        // 破坏时间设定
        SabotageTimeControl = BooleanOptionItem
            .Create(3_021_001, "SabotageTimeControl", false, TabGroup.GameSettings, false)
            .SetColor(new Color32(241, 212, 227, byte.MaxValue))
            .SetGameMode(CustomGameMode.Standard);
        PolusReactorTimeLimit = FloatOptionItem
            .Create(3_021_002, "PolusReactorTimeLimit", new(1f, 60f, 1f), 30f, TabGroup.GameSettings, false)
            .SetParent(SabotageTimeControl)
            .SetValueFormat(OptionFormat.Seconds)
            .SetGameMode(CustomGameMode.Standard);
        AirshipReactorTimeLimit = FloatOptionItem
            .Create(3_021_003, "AirshipReactorTimeLimit", new(1f, 90f, 1f), 60f, TabGroup.GameSettings, false)
            .SetParent(SabotageTimeControl)
            .SetValueFormat(OptionFormat.Seconds)
            .SetGameMode(CustomGameMode.Standard);
        FungleReactorTimeLimit = FloatOptionItem
            .Create(3_021_004, "FungleReactorTimeLimit", new(1f, 90f, 1f), 60f, TabGroup.GameSettings, false)
            .SetParent(SabotageTimeControl)
            .SetValueFormat(OptionFormat.Seconds)
            .SetGameMode(CustomGameMode.Standard);
        FungleMushroomMixupDuration = FloatOptionItem
            .Create(3_021_005, "FungleMushroomMixupDuration", new(1f, 20f, 1f), 10f, TabGroup.GameSettings, false)
            .SetParent(SabotageTimeControl)
            .SetValueFormat(OptionFormat.Seconds)
            .SetGameMode(CustomGameMode.Standard);

        // 停电特殊设定（飞艇）
        LightsOutSpecialSettings = BooleanOptionItem
            .Create(3_022_001, "LightsOutSpecialSettings", false, TabGroup.GameSettings, false)
            .SetColor(new Color32(241, 212, 227, byte.MaxValue))
            .SetGameMode(CustomGameMode.Standard);
        DisableAirshipViewingDeckLightsPanel = BooleanOptionItem
            .Create(3_022_002, "DisableAirshipViewingDeckLightsPanel", false, TabGroup.GameSettings, false)
            .SetParent(LightsOutSpecialSettings)
            .SetGameMode(CustomGameMode.Standard);
        DisableAirshipGapRoomLightsPanel = BooleanOptionItem
            .Create(3_022_003, "DisableAirshipGapRoomLightsPanel", false, TabGroup.GameSettings, false)
            .SetParent(LightsOutSpecialSettings)
            .SetGameMode(CustomGameMode.Standard);
        DisableAirshipCargoLightsPanel = BooleanOptionItem
            .Create(3_022_004, "DisableAirshipCargoLightsPanel", false, TabGroup.GameSettings, false)
            .SetParent(LightsOutSpecialSettings)
            .SetGameMode(CustomGameMode.Standard);
        BlockDisturbancesToSwitches = BooleanOptionItem
            .Create(3_022_005, "BlockDisturbancesToSwitches", false, TabGroup.GameSettings, false)
            .SetParent(LightsOutSpecialSettings)
            .SetGameMode(CustomGameMode.Standard);

        // 修改破坏冷却时间
        ModifySabotageCooldown = BooleanOptionItem
            .Create(3_023_001, "ModifySabotageCooldown", false, TabGroup.GameSettings, false)
            .SetColor(new Color32(241, 212, 227, byte.MaxValue))
            .SetGameMode(CustomGameMode.Standard);
        SabotageCooldown = FloatOptionItem
            .Create(3_023_002, "SabotageCooldown", new(1f, 60f, 1f), 30f, TabGroup.GameSettings, false)
            .SetParent(ModifySabotageCooldown)
            .SetValueFormat(OptionFormat.Seconds)
            .SetGameMode(CustomGameMode.Standard);
        ...
        AirShipVariableElectrical = BooleanOptionItem
            .Create(3_030_001, "AirShipVariableElectrical", false, TabGroup.GameSettings, false)
            .SetHeader(true)
            .SetColor(new Color32(85, 170, 255, byte.MaxValue));
        DisableAirshipMovingPlatform = BooleanOptionItem.Create(3_030_002, "DisableAirshipMovingPlatform", false,
                TabGroup.GameSettings, false)
            .SetColor(new Color32(85, 170, 255, byte.MaxValue));
        ResetDoorsEveryTurns = BooleanOptionItem
            .Create(3_030_003, "ResetDoorsEveryTurns", false, TabGroup.GameSettings, false)
            .SetColor(new Color32(85, 170, 255, byte.MaxValue));
        DoorsResetMode = StringOptionItem
            .Create(3_030_004, "DoorsResetMode", EnumHelper.GetAllNames<DoorsReset.ResetMode>(), 0,
                TabGroup.GameSettings, false).SetParent(ResetDoorsEveryTurns)
            .SetColor(new Color32(85, 170, 255, byte.MaxValue));
        DisableFungleSporeTrigger = BooleanOptionItem
            .Create(3_030_005, "DisableFungleSporeTrigger", false, TabGroup.GameSettings, false)
            .SetColor(new Color32(85, 170, 255, byte.MaxValue));
        ...
        RandomMapsMode = BooleanOptionItem.Create(3_040_001, "RandomMapsMode", false, TabGroup.GameSettings, false)
            .SetHeader(true)
            .SetColor(new Color32(193, 255, 209, byte.MaxValue));
        AddedTheSkeld = BooleanOptionItem.Create(3_040_002, "AddedTheSkeld", false, TabGroup.GameSettings, false)
            .SetParent(RandomMapsMode);
        AddedMiraHQ = BooleanOptionItem.Create(3_040_003, "AddedMIRAHQ", false, TabGroup.GameSettings, false)
            .SetParent(RandomMapsMode);
        AddedPolus = BooleanOptionItem.Create(3_040_004, "AddedPolus", false, TabGroup.GameSettings, false)
            .SetParent(RandomMapsMode);
        AddedTheAirShip = BooleanOptionItem.Create(3_040_005, "AddedTheAirShip", false, TabGroup.GameSettings, false)
            .SetParent(RandomMapsMode);
        // MapDleks = CustomOption.Create(3_040_006, Color.white, "AddedDleks", false, RandomMapMode);
        AddedTheFungle = BooleanOptionItem.Create(3_040_007, "AddedTheFungle", false, TabGroup.GameSettings, false)
            .SetParent(RandomMapsMode);
        ...
        LadderDeath = BooleanOptionItem.Create(3_042_001, "LadderDeath", false, TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(new Color32(193, 255, 209, byte.MaxValue));
        LadderDeathChance = StringOptionItem
            .Create(3_042_002, "LadderDeathChance", Rates[1..], 0, TabGroup.GameSettings, false).SetParent(LadderDeath)
            .SetGameMode(CustomGameMode.Standard);

        // 修正首刀时间
        FixFirstKillCooldown = BooleanOptionItem
            .Create(3_043_001, "FixFirstKillCooldown", true, TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(new Color32(193, 255, 209, byte.MaxValue));

        // 首刀保护
        ShieldPersonDiedFirst = BooleanOptionItem
            .Create(3_044_001, "ShieldPersonDiedFirst", false, TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(new Color32(193, 255, 209, byte.MaxValue));

        // 杀戮闪烁持续
        KillFlashDuration = FloatOptionItem.Create(3_045_001, "KillFlashDuration", new(0.1f, 0.45f, 0.05f), 0.3f,
                TabGroup.GameSettings, false)
            .SetColor(new Color32(193, 255, 209, byte.MaxValue))
            .SetValueFormat(OptionFormat.Seconds)
            .SetGameMode(CustomGameMode.Standard);
        ...
        GhostIgnoreTasks = BooleanOptionItem.Create(3_050_001, "GhostIgnoreTasks", false, TabGroup.GameSettings, false)
            ...
            .SetHeader(true)
            .SetColor(new Color32(217, 218, 255, byte.MaxValue));
        GhostCanSeeOtherRoles = BooleanOptionItem
            .Create(3_050_002, "GhostCanSeeOtherRoles", true, TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(new Color32(217, 218, 255, byte.MaxValue));
        GhostCanSeeOtherTasks = BooleanOptionItem
            .Create(3_050_003, "GhostCanSeeOtherTasks", true, TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(new Color32(217, 218, 255, byte.MaxValue));
        GhostCanSeeOtherVotes = BooleanOptionItem
            .Create(3_050_004, "GhostCanSeeOtherVotes", true, TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(new Color32(217, 218, 255, byte.MaxValue));
        GhostCanSeeDeathReason = BooleanOptionItem
            .Create(3_050_005, "GhostCanSeeDeathReason", true, TabGroup.GameSettings, false)
            .SetGameMode(CustomGameMode.Standard)
            .SetColor(new Color32(217, 218, 255, byte.MaxValue));
    ...
    public static void SetupAddonOptions(int id, TabGroup tab, CustomRoles role,
        CustomGameMode customGameMode = CustomGameMode.Standard)
        => SetupAddonOptions(id, tab, role, Rates, true, customGameMode);

    public static void SetupAddonOptions(int id, TabGroup tab, CustomRoles role, string[] selections, bool canSetNum,
        CustomGameMode customGameMode = CustomGameMode.Standard)
    {
        IntegerValueRule assignCountRule = role is CustomRoles.Lovers ? new(2, 2, 2) : new(1, canSetNum ? 15 : 1, 1);

        var spawnOption = new RoleSpawnChanceOptionItem(id, role.ToString(), 0, tab, false, selections, role,
    ...
    public static void SetupRoleOptions(int id, TabGroup tab, CustomRoles role, Color roleColor,
        IntegerValueRule assignCountRule = null, CustomGameMode customGameMode = CustomGameMode.Standard)
    {
        ...
        var spawnOption =
            new RoleSpawnChanceOptionItem(id, role.ToString(), 0, tab, false, RoleSpwanModes, role, roleColor)
    ...
    private static void SetupMadmateRoleOptionsToggle(int id, CustomGameMode customGameMode = CustomGameMode.Standard)
    {
        ...
        var spawnOption = new RoleSpawnChanceOptionItem(id, role.ToString(), 0, TabGroup.Addons, false, RoleSpwanToggle,
                role, Utils.GetRoleColor(role))
            .SetColor(Utils.GetRoleColor(role))
            .SetHeader(true)
            .SetGameMode(customGameMode) as StringOptionItem;

        var countOption = IntegerOptionItem.Create(id + 1, "Maximum", new(1, 15, 1), 1, TabGroup.Addons, false)
            .SetParent(spawnOption)
            .SetGameMode(customGameMode);

        MadmateSpawnMode = StringOptionItem
            .Create(id + 10, "MadmateSpawnMode", madmateSpawnMode, 0, TabGroup.Addons, false).SetParent(spawnOption);
        MadmateCountMode = StringOptionItem
            .Create(id + 11, "MadmateCountMode", madmateCountMode, 0, TabGroup.Addons, false).SetParent(spawnOption);
        SheriffCanBeMadmate = BooleanOptionItem.Create(id + 12, "SheriffCanBeMadmate", false, TabGroup.Addons, false)
            .SetParent(spawnOption);
        MayorCanBeMadmate = BooleanOptionItem.Create(id + 13, "MayorCanBeMadmate", false, TabGroup.Addons, false)
            .SetParent(spawnOption);
        NGuesserCanBeMadmate = BooleanOptionItem.Create(id + 14, "NGuesserCanBeMadmate", false, TabGroup.Addons, false)
            .SetParent(spawnOption);
        SnitchCanBeMadmate = BooleanOptionItem.Create(id + 15, "SnitchCanBeMadmate", false, TabGroup.Addons, false)
            .SetParent(spawnOption);
        MadSnitchTasks = IntegerOptionItem.Create(id + 16, "MadSnitchTasks", new(1, 99, 1), 3, TabGroup.Addons, false)
            .SetParent(SnitchCanBeMadmate)
            .SetValueFormat(OptionFormat.Pieces);
        JudgeCanBeMadmate = BooleanOptionItem.Create(id + 17, "JudgeCanBeMadmate", false, TabGroup.Addons, false)
            .SetParent(spawnOption);
    ...
    public class OverrideTasksData
    {
        ...
        public OverrideTasksData(int idStart, TabGroup tab, CustomRoles role)
        {
            ...
            Dictionary<string, string> replacementDic = new()
                { { "%role%", Utils.ColorString(Utils.GetRoleColor(role), Utils.GetRoleName(role)) } };
