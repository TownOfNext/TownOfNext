...
class OnPlayerLeftPatch
{
    static void Prefix([HarmonyArgument(0)] ClientData data)
    {
        ...
        CustomRoleManager.AllActiveRolesAndAddonsList.ToList().Do(role => role.OnPlayerDeath(data.Character, PlayerState.GetByPlayerId(data.Character.PlayerId).DeathReason, GameStates.IsMeeting));
    }
